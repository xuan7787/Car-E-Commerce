...
module.exports = observableModule.fromObject({
  ...
  displayData(carDataArray){
    var observableArray = new observableArrayModule.ObservableArray(carDataArray);
  ...
  //========== Handlers ==========//
  onLoaded(args){
    mainPageViewModel.onEnterSearchResult();
    ...
    this.searchResultData = new observableArrayModule.ObservableArray();
    this.displayData(datastore.searchResultsStore);
